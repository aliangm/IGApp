...
export default class AttributionTable extends Component {
  ...
  render() {
    ...
    const toolTipTextMapping = {
      'influenced-stage-indicator': `# of ${getNicknameForIndicator(stageIndicatorKey,
        true)} conversion journeys which the ${titleColumnNameLower} took part in`,
      ...
      'revenue': `Total revenue generated by the ${titleColumnNameLower}. Calculated by ${attributionModel} model`
    };
