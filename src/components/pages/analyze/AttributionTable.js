...
export default class AttributionTable extends Component {
  ...
  render() {
    const {showCostColumns, showTotalRow, additionalColumns, formatAdditionColumn, formatAdditionColumnTotal, data, dataNickname, getItemCost, getItemData, getItemTitle, additionalColumnValue} = this.props;
    ...
    const toolTipTextMapping = {
      'influenced-stage-indicator': `# of ${getNickname(stageIndicatorKey, true)} conversion journeys which the ${titleColumnNameLower} took part in`,
      'stage-indicator': `# of ${pluralNickname(stageIndicatorKey)} generated by the ${titleColumnNameLower}. Calculated by x model`,
      'influenced-revenue': `Total revenue generated from journeys which the ${titleColumnNameLower} took part in`,
      'revenue': `Total revenue generated by the ${titleColumnNameLower}. Calculated by x model`
    };
