      ...
      <Page popup={ isPopupMode() } width={isPopupMode() ? 'initial' : '1051px'}>
        ...
        { this.state.isLoaded ?
          ...
          <div className={ this.classes.colLeft }>
            ...
            <div className={ indiStyle.locals.row }>
              <Item icon="indicator:ltv" title="Life Time Value" name="LTV" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.LTV } maxValue={400000} isDollar={true} />
              <Item icon="indicator:cac" title="Customer Acquisition Cost" name="CAC" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.CAC } maxValue={20000} isDirectionDown= { true } isDollar={true} />
              ...
              <Item icon="indicator:users" title="Accounts" name="users" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.users } maxValue={7000} />
            ...
            <div className={ indiStyle.locals.row }>
              ...
              <Item icon="indicator:arpa" title="ARPA (monthly)" name="ARPA" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.ARPA } maxValue={17000} isDollar={true} />
            </div>
          </div>
