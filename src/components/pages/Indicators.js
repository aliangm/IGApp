          ...
          <div className={ this.classes.cols }>
            <div className={ this.classes.colLeft }>
              <div className={ indiStyle.locals.row }>
                <Item icon="indicator:facebook" title="Facebook Likes" name="facebookLikes" updateIndicator={ this.handleChange } defaultStatus = { this.props.actualIndicators.facebookLikes } maxValue={50000} description="The number of likes in your Facebook page."/>
              ...
              <div className={ indiStyle.locals.row }>
                <Item icon="indicator:mcl" title="Leads" name="MCL" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.MCL } maxValue={10000} isFunnel={true} description="Marketing Captured Leads."/>
                <Item icon="indicator:mql" title="Marketing Qualified Leads" name="MQL" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.MQL } maxValue={5000} isFunnel={true} description="Marketing Qualified Leads."/>
                <Item icon="indicator:sql" title="Sales Qualified Leads" name="SQL" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.SQL } maxValue={2000} isFunnel={true} description="Sales Qualified Leads."/>
                <Item icon="indicator:opps" title="Opportunities" name="opps" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.opps } maxValue={1000} isFunnel={true} description="Opportunities."/>
              </div>
              <div className={ indiStyle.locals.row }>
                ...
                <Item icon="indicator:trialUsers" title="Trial Users" name="trialUsers" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.trialUsers } maxValue={2500} description="The number of trial users the company currently has."/>
                 <Item icon="indicator:users" title="Paying Accounts" name="users" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.users } maxValue={7000} description="The numbers of paying customers the company currently has (an account can have multiple users)."/>
