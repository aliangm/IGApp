          ...
          { this.state.isLoaded ?
            ...
            <div className={ this.classes.colLeft }>
              <div className={ indiStyle.locals.row }>
                ...
                <Item icon="indicator:facebookEngagement" title="Facebook Engagement" name="facebookEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.facebookEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:twitterEngagement" title="Twitter Engagement" name="twitterEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.twitterEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:linkedinEngagement" title="LinkedIn Engagement" name="linkedinEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.linkedinEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:instagramEngagement" title="Instagram Engagement" name="instagramEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.instagramEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:googleEngagement" title="Google+ Engagement" name="googlePlusEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.googlePlusEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:pinterestEngagement" title="Pinterest Engagement" name="pinterestEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.pinterestEngagement } maxValue='100' isPercentage = 'true' />
                ...
                <Item icon="indicator:youtubeEngagement" title="Youtube Engagement" name="youtubeEngagement" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.youtubeEngagement } maxValue='100' isPercentage = 'true' />
              </div>
              <div className={ indiStyle.locals.row }>
                ...
                <Item icon="indicator:cac" title="Customer Acquisition Cost" name="CAC" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.CAC } maxValue='700' />
              ...
              <div className={ indiStyle.locals.row }>
                ...
                <Item icon="indicator:averageSessionDuration" title="Average Session Duration" name="averageSessionDuration" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.averageSessionDuration } maxValue='300' />
                <Item icon="indicator:bounceRate" title="Bounce Rate" name="bounceRate" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.bounceRate } isPercentage = 'true' maxValue='100' />
              ...
              <div className={ indiStyle.locals.row }>
                ...
                <Item icon="indicator:churnRate" title="Churn Rate" name="churnRate" updateIndicator = { this.handleChange } defaultStatus = { this.state.actualIndicators.churnRate } isPercentage = 'true' maxValue='18' isPercentage = 'true'/>
              </div>
            </div>
