        ...
        <div className={ this.classes.cols }>
          <div className={ this.classes.colLeft }>
            ...
            <div className={ indiStyle.locals.row }>
              ...
              <Item icon="indicator:blogVisits" title="Blog Visits" name="blogVisits" updateIndicator = { this.handleChange } defaultStatus = { this.props.actualIndicators.blogVisits } maxValue={25000} description="Blog total visits during the last 30 days." showAutomaticPopup={ this.showAnalyticsPopup.bind(this) } automaticIndicators={ this.props.isBlogAuto }/>
