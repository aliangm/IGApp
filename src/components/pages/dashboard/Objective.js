...
export default class Objective extends Component {
  ...
  render() {
    let options = {
      ...
      arrowValue: this.props.directionDown ? (this.props.current * 1.5 - this.props.current) / (this.props.current * 1.5 - this.props.maxRange) : (this.props.current - this.props.current/2) / (this.props.maxRange - this.props.current/2),
