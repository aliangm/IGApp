...
export default class Insights extends Component {
    ...
    render() {
        ...
        cubesData = cubesData.filter(data=>
            !(
        ...
        const cubes = cubesData.map((data)=>{
            return <InsightItem
                ...
                objectivesRatio={data.objectivesRatio}
                dates={data.dates}
                currentBudget={data.currentBudget}
                suggestedBudget={data.suggestedBudget}
                approveChannel={data.approveChannel}
                declineChannel={data.declineChannel}
                findBalancer={data.findBalancer}
            />
        });
