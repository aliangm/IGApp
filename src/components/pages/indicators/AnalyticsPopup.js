  ...
  render(){
    return <div>
      <div hidden={ this.props.hidden }>
        <GoogleAutomaticPopup setDataAsState={ this.props.setDataAsState } close={ this.props.close } data={this.props.googleAuto} ref="googleAnalytics"/>
        <Page popup={ true } width={'340px'} style={{ zIndex: '9' }}>
          <div className={ this.classes.close } onClick={ this.props.close }/>
          <div className={ this.classes.inner }>
            <div className={ this.classes.row }>
              <div className={ CRMStyle.locals.googleAnalytics } onClick={ () => { this.refs.googleAnalytics.open() } }/>
            </div>
          </div>
        </Page>
      </div>
