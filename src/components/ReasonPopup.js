...
export default class ReasonPopup extends Component {
  ...
  addReasonToAccount(reason){
    if (reason) {
      ...
      userAccount.reasonForUse = reason;
        ...
        <div className={ this.classes.center }>
          <div className={ this.classes.inner }>
            ...
            <div className={ this.classes.boxes }>
              ...
              <div className={ this.classes.optimize } onClick={ () => { this.addReasonToAccount("optimize current mix") } }>
                <div className={ this.classes.boxText }>
                  Optimize my current maketing mix
                </div>
              </div>
              <div className={ this.classes.control } onClick={ () => { this.addReasonToAccount("control and visibility") } }>
                <div className={ this.classes.boxText }>
                  Get control & visibility over my marketing mix and data
                </div>
              </div>
              <div className={ this.classes.endToEnd } onClick={ () => { this.addReasonToAccount("end to end planning") } }>
                <div className={ this.classes.boxText }>
            ...
            <div className={ this.classes.center }>
              <input
                ...
                onChange={ () => { this.setState({isOther: !this.state.isOther}) } }
              />
              <div className={ this.classes.subTitleBold }>
                Other?
              </div>
