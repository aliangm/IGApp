...
var schema = require('./channelsSchema');
var _ = require('lodash');
var fs = require('fs');

function parseAnnualPlan(data) {
  var sum = {};
  var returnObj = {};
...
fs.readFile('C:/Users/Dor/Desktop/files BUG strange channels sums/.outputPlan.json', 'utf-8', function(err, data){
  data = JSON.parse(data);
  parseAnnualPlan(data);
});